#
# Vivado generated .tcl for creating the pcileech_Captain_100T_x1 vivado project.
...
set _xil_proj_name_ "pcileech_Captain_100T_x1"
...
set orig_proj_dir "[file normalize "$origin_dir/pcileech_captain100t_x1"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/src/pcileech_captain_100t_x1_top.sv"]\
...
set file "src/pcileech_captain_100t_x1_top.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "pcileech_captain_100t_x1_top" -objects $obj
...
set file "[file normalize ${origin_dir}/src/pcileech_100t.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "src/pcileech_100t.xdc"
